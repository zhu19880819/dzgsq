			...
			<section class="item-show__div item-show__head clearfix">
				<div class="pull-left">
					<ol class="breadcrumb">
						...
						<li class="active">${wsProduct.title}</li>
					</ol>
					<div class="item-pic__box" id="magnifier">
						<div class="small-box">
							<img class="cover" src="${wsProduct.prodImage}" alt="${wsProduct.title}">
						...
						<div class="thumbnail-box">
							...
							<div class="thumb-list">
								<ul class="wrapper clearfix">
									<c:forEach items="${wsProduct.prodImageList}" var="prodImage">
									<li class="item" data-src="${prodImage}"><img class="cover" src="${prodImage}" alt="商品预览图"></li>
									</c:forEach>
								</ul>
							</div>
					...
					<div class="item-info__box">
						<div class="item-title">
							<div class="name ep2">${wsProduct.title}</div>
							<div class="sale cr">优惠活动：积分兑换优惠价更优惠哦！</div>
						</div>
						<div class="item-price bgf5">
							<div class="price-box clearfix">
								<div class="price-panel pull-left">
									售价：<span class="price">￥${wsProduct.rangePrice} <s class="fz16 c9">￥${wsProduct.defaultPrice}</s></span>
								</div>
							</div>
						</div>
						<ul class="item-ind-panel clearfix">
							<li class="item-ind-item">
								...
								<span class="ind-count cr">${wsProduct.selNum}</span>
							</li>
							<li class="item-ind-item">
								<a href=""><span class="ind-label c9">累计评论</span>
									<span class="ind-count cr">${wsConsulationCount}</span></a>
							</li>
						</ul>
						<div class="item-key">
							<div class="item-sku">
								<dl class="item-prop clearfix">
									...
									<dd>
										<ul class="clearfix">
											<c:forEach items="${wsProdSkuList}" var="wsProdSku">
											<li>
												<a class="on" href="javascript:;" role="button" data-value="白色" aria-disabled="true">
													<span>${wsProdSku.skuName}</span>
												</a>
											</li>
											</c:forEach>
										</ul>
							...
							<div class="item-amount clearfix bgf5">
								...
								<div class="amount-box">
									...
									<div class="item-stock"><span style="margin-left: 10px;">库存 <b id="Stock">${wsProduct.defaultNum}</b> 件</span></div>
									<script>
										$(function() {
											...
											$('.amount-widget').on('click', '.amount-but', function() {
												...
												if($(this).hasClass('add')) {
													if(num > stock - 1) {
														return DJMask.open({width: "300px",　height: "100px",content: "您输入的数量超过库存上限"});
													}
													$('.amount-input').val(num + 1);
												} else if($(this).hasClass('sub')) {
													if(num == 1) {
														return DJMask.open({　　width: "300px",height: "100px",content: "您输入的数量有误"});
													}
													$('.amount-input').val(num - 1);
												}
											});
							...
							<div class="item-action clearfix bgf5">
								<a href="javascript:buyProd();" rel="nofollow" data-addfastbuy="true" title="点击此按钮，到下一步确认购买信息。" role="button" class="item-action__buy">立即购买</a>
					...
					<div class="swiper-container picked-swiper">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<c:forEach items="${homeProductList}" var="homeProduct">
								<a class="picked-item" href="">
									<img src="${homeProduct.prodImage}" alt="" class="cover">
									<div class="look_price">${homeProduct.minPrice}</div>
								</a>
								</c:forEach>
							</div>
						</div>
				...
				<div class="item-nav-tabs">
					<ul class="nav-tabs nav-pills clearfix" role="tablist" id="item-tabs">
						<li role="presentation" class="active">
							<a href="#detail" role="tab" data-toggle="tab" aria-controls="detail" aria-expanded="true">商品详情</a>
						</li>
						<li role="presentation">
							<a href="#service" role="tab" data-toggle="tab" aria-controls="service">商品属性</a>
						</li>
						<li role="presentation">
							<a href="#evaluate" role="tab" data-toggle="tab" aria-controls="service">商品平均 <span class="badge">1314</span></a>
						</li>
					</ul>
				</div>
				<div class="pull-left">
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane fade" id="evaluate" aria-labelledby="evaluate-tab">
							<div class="evaluate-tabs bgf5">
								<ul class="nav-tabs nav-pills clearfix" role="tablist">
									<li role="presentation" class="active">
										<a href="#all" role="tab" data-toggle="tab" aria-controls="all" aria-expanded="true">全部评价 <span class="badge">1314</span></a>
									</li><li role="presentation">
										<a href="#good" role="tab" data-toggle="tab" aria-controls="good">好评 <span class="badge">1000</span></a>
									</li>
									<li role="presentation">
										<a href="#normal" role="tab" data-toggle="tab" aria-controls="normal">中评 <span class="badge">314</span></a>
									</li>
									<li role="presentation">
										<a href="#bad" role="tab" data-toggle="tab" aria-controls="bad">差评 <span class="badge">0</span></a>
									</li>
								</ul>
							</div>
									...
									<div role="tabpanel" class="tab-pane fade in active" id="all" aria-labelledby="all-tab">
										...
										<div class="eval-box">
											<div class="eval-author">
												<div class="port">
													<img src="images/pp05.png" alt="欢迎来到Wshop汇达商城" class="cover b-r50">
												</div>
											...
											<div class="eval-content">
												...
												<div class="eval-imgs">
													<div class="img-temp"><img src="images/S-0011.jpg" data-src="images/temp/S-001-1_b.jpg" data-action="zoom" class="cover"></div>
													<div class="img-temp"><img src="images/S-0012.jpg" data-src="images/temp/S-001-2_b.jpg" data-action="zoom" class="cover"></div>
													<div class="img-temp"><img src="images/S-0013.jpg" data-src="images/temp/S-001-3_b.jpg" data-action="zoom" class="cover"></div>
													<div class="img-temp"><img src="images/S-0014.jpg" data-src="images/temp/S-001-4_b.jpg" data-action="zoom" class="cover"></div>
													<div class="img-temp"><img src="images/S-0015.jpg" data-src="images/temp/S-001-5_b.jpg" data-action="zoom" class="cover"></div>
												</div>
												<div class="eval-time">
													2018年05月11日 20:31 颜色分类：深棕色 尺码：均码
												</div>
											</div>
										</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="service" aria-labelledby="service-tab">
							...
							<div class="service-content rich-text">
								...
								<div style="text-align:center"><img src="http://img.aocmonitor.com.cn/image/2017-05/89154415.jpg" alt=""></div>
								<p><br></p>
								<p>三包服务如下：</p>
								<ol>
								...
								<div style="text-align:center"><img src="http://img.aocmonitor.com.cn/image/2017-05/25352146.jpg" alt=""></div>
								<p><br></p>
