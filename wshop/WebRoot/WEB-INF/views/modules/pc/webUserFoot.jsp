			...
			<section class="user-center inner clearfix">
				...
				<div class="pull-right">
					<div class="user-content__box clearfix bgf">
						<div class="title">订单中心-我的足迹</div>
						<div class="collection-list__area clearfix">
						
							<c:forEach items="${wsMemberVisitLogList}" var="wsMemberVisitLog">
							<div class="item-card">
								<a href="${wsMemberVisitLog.wsProduct.prodImage}" class="photo">
									<img src="${wsMemberVisitLog.wsProduct.prodImage}" alt="${wsMemberVisitLog.wsProduct.title}" class="cover">
									<div class="name">${wsMemberVisitLog.wsProduct.title}</div>
								</a>
								<div class="middle">
									<div class="price"><small>￥</small>${wsMemberVisitLog.wsProduct.defaultPrice}</div>
									<div class="sale">
										<a href="">取消收藏</a>
									</div>
								</div>
