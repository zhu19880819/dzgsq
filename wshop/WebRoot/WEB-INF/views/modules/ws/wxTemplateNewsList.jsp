	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				<form:form id="searchForm" modelAttribute="wxMaterialNews" action="${ctx}/ws/wxMaterialNews/templateList" method="post" class="form-horizontal">
					...
					<c:forEach items="${page.list}" var="wxMaterialNews">
						<tr>
							...
							<shiro:hasPermission name="ws:wxMaterialNews:edit"><td>
			    				<a onclick="parent.selectTemplate('${wxMaterialNews.id}','${wxMaterialNews.title}')" class="btn btn-success btn-sm"><span class=""><i class="fa fa-pencil">&nbsp;选择</i></span></a>
