...
<body>
	...
	<table id="contentTable" class="table table-bordered table-striped table-hover dataTable no-footer">
		<tr><th>名称</th><th>分类</th><th>备注</th><shiro:hasPermission name="gen:genTemplate:edit"><th>操作</th></shiro:hasPermission></tr>
		<c:forEach items="${page.list}" var="genTemplate">
			<tr>
				...
				<shiro:hasPermission name="gen:genTemplate:edit"><td>
    				<a href="${ctx}/gen/genTemplate/form?id=${genTemplate.id}" class="btn btn-success btn-sm"><span class=""><i class="fa fa-pencil">&nbsp;修改</i></span></a>
					<a href="${ctx}/gen/genTemplate/delete?id=${genTemplate.id}" onclick="return confirmx('确认要删除该代码模板吗？', this.href)" class="btn btn-warning btn-sm"><i class="fa fa-trash">&nbsp;删除</i></a>
