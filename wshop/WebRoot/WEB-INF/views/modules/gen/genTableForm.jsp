		          ...
		          <div class="box box-primary">
					<form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/save" method="post" class="form-horizontal">
						...
						<fieldset>
							...
							<div class="form-group">
								<label  class="col-sm-1 control-label">父表名:</label>
								<div class="col-sm-4 controls">
								...
								<label  class="col-sm-2 control-label">当前表外键：</label>
								<div class="col-sm-4 controls">
							...
							<div class="control-group">
								<table id="contentTable" class="table table-striped table-bordered table-condensed">
									<tr><th title="数据库字段名">列名</th><th title="默认读取数据库字段备注">说明</th><th title="数据库中设置的字段类型及长度">物理类型</th><th title="实体对象的属性字段类型">Java类型</th>
										...
										<th title="字段在表单中显示的类型">显示表单类型</th><th title="显示表单类型设置为“下拉框、复选框、点选框”时，需设置字典的类型">字典类型</th><th>排序</th></tr>
