...
<body>
		...
		<div class="col-md-12">
			...
			<div class="form-group">
				...
				<div class="col-sm-3 control-label ">
					<form:radiobuttons cssStyle="margin: 5px;" onclick="$('#searchForm').submit();" path="delFlag" items="${fns:getDictList('cms_del_flag')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
                </div>
			</div>
		</div>
	...
	<table id="contentTable" class="table table-bordered table-striped table-hover dataTable no-footer">
		<tr><th class="text-center">栏目</th><th class="text-center">标题</th><th class="text-center">权重</th>
		<th class="text-center">点击数</th><th class="text-center">发布者</th><th class="text-center">更新时间</th><th class="text-center">操作</th></tr>
