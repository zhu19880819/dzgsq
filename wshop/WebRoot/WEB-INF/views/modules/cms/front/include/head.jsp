...
<%-- <script src="${ctxStatic}/bootstrap/2.3.1/js/bootstrap.min.js" type="text/javascript"></script> --%>
 ...
 <link rel="alternate icon" type="${ctxStaticTheme}/img/hengwang-1.png" href="${ctxStaticTheme}/img/hengwang-1.png">
  <link rel="stylesheet" href="${ctxStaticTheme}/css/amazeui.css"/>
  <link rel="stylesheet" href="${ctxStaticTheme}/css/style.css"/>
	
	<script src="${ctxStaticTheme}/js/jquery.min.js"></script>
	<script src="${ctxStaticTheme}/js/amazeui.min.js"></script>
	<script src="${ctxStaticTheme}/js/scroll.js"></script>
