         ...
         <div class="box box-primary">
			<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-1 controls control-label">
		                <span>
				...
				<div class="form-group">
					...
					<div class="col-sm-10 controls">
						<textarea name="articleData.content" id="editor" cols="100" rows="8" style="width:700px;height:400px;visibility:hidden;">${article.articleData.content}</textarea>
				...
				<div class="form-group">
					...
					<div class="col-sm-4 controls">
						<form:hidden id="articleDataRelation" path="articleData.relation" htmlEscape="false" maxlength="200" class="form-control"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-4 control-label" id="control-label-left">
				...
				<shiro:hasPermission name="cms:article:audit">
					<div class="form-group">
						...
						<div class="col-sm-3 control-label " id="control-label-left">
