...
/** 
* @ClassName: WxDataCubeStreamArticleTotalParam 
* @Description: 获取图文群发送总数 最大时间跨度 1
* @author zhaoxl
* @date 2015年1月29日 下午10:40:07
*/
@ReqType("getArticleTotal")
public class WxDataCubeStreamArticleTotalParam extends WeixinReqParam{
