package com.thinkgem.jeesite.modules.wx.core.common;
...
//			conn.setDoInput(true);
	 ...
	 * @throws Exception
	 */
	public static JSONObject uploadMediaFileVideo(String requestUrl, File file,
			String content_type,String title,String introduction) {
		String result = null;
		JSONObject jsonObject = null;
		URL submit = null;
		if (!file.exists() || !file.isFile()) {
