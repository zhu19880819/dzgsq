...
/** 
* @ClassName: WxDataCubeStreamUserReadHourParam 
* @Description: 获取图文统计分时数据，最大时间跨度 1
* @author zhaoxl
* @date 2015年1月29日 下午10:40:07
*/
@ReqType("getUserReadHour")
public class WxDataCubeStreamUserReadHourParam extends WeixinReqParam{
