package com.thinkgem.jeesite.modules.wx.wxbase.wxmedia;
...
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxArticlesRequest;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxArticlesRequestByMaterial;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxArticlesRespponseByMaterial;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxCountResponse;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxDescriptionRequest;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxDwonload;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxItem;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxMediaForMaterial;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxMediaForMaterialResponse;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxNews;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxNewsArticle;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxUpdateArticle;
import com.thinkgem.jeesite.modules.wx.wxbase.wxmedia.model.WxUpload;
...
import com.thinkgem.jeesite.modules.wx.wxsendmsg.model.WxArticlesResponse;
...
public class JwMediaAPI {
	 ...
	 * @throws WexinReqException
	 */
	public static WxMediaForMaterialResponse addMediaFileVideo(String accesstoken, String type,
			String fileName,String title,String introduction) throws WexinReqException {
		WxMediaForMaterialResponse mediaResource = null;
		if (accesstoken != null) {
			String requestUrl = add_material.replace("ACCESS_TOKEN", accesstoken);
			String url = requestUrl.replace("TYPE", type);
			...
			String contentType = WeiXinReqUtil.getFileContentType(fileName.substring(fileName.lastIndexOf(".") + 1));
			JSONObject result = WxstoreUtils.uploadMediaFileVideo(url, file, contentType,title,introduction);
			if (result.containsKey("errcode")) {
				logger.error("新增其他永久素材 失败！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
				throw new WexinReqException(result.getString("errcode"));
			} else {
