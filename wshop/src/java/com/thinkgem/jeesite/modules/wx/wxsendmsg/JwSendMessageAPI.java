package com.thinkgem.jeesite.modules.wx.wxsendmsg;
...
import com.thinkgem.jeesite.modules.wx.core.common.HttpPostUtil;
...
import com.thinkgem.jeesite.modules.wx.core.req.model.user.Group;
...
import com.thinkgem.jeesite.modules.wx.wxsendmsg.model.SendMessageReport;
import com.thinkgem.jeesite.modules.wx.wxsendmsg.model.SendMessageResponse;
...
import com.thinkgem.jeesite.modules.wx.wxsendmsg.model.WxMedia;
import com.thinkgem.jeesite.modules.wx.wxsendmsg.model.WxMediaResponse;
import com.thinkgem.jeesite.modules.wx.wxsendmsg.util.ReadImgUrls;
...
//				JSONObject result = WxstoreUtils.uploadMediaFile(requestUrl, file, contentType);
	 ...
	 * @throws WexinReqException
	 */
	public static SendMessageResponse sendMessageToGroupOrAllWithMediaId(String accesstoken, boolean is_to_all,Group group, String wxMediaId,String wxMediaType) throws WexinReqException {
		...
		if (accesstoken != null) {
			...
			try {
				...
				media.put("media_id", wxMediaId);
				obj.put(wxMediaType, media);

				obj.put("msgtype",wxMediaType);
