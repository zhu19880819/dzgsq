...
import com.thinkgem.jeesite.modules.wx.pay.WcxPayConfigImpl;

@Service
@Transactional(readOnly = true)
public class WcxPayService extends BaseService{
	...
	public Map orderPay(WsMember member,List<WsOrderItem> wsOrderItems,String ip,String notify) throws Exception {
		...
		data.put("appId",account.getWcxAppid());
