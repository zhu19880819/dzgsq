...
public class Page<T> {
	...
	private int begin;//开始分页的按钮
	
	private int end;//结束分页的按钮
	...
	public void initialize(){
		...
		this.begin = pageNo - (length / 2);

		if (this.begin < this.first) {
		...
		if (this.end >= this.last) {
			this.end = this.last;
			this.begin = this.end - this.length + 1;
			if (this.begin < this.first) {
				this.begin = this.first;
			}
		}
	...
	public String toString() {
		...
		sb.append("<div class=\"col-sm-5\"><div class=\"dataTables_info\" id=\"user_table_info\" role=\"status\" aria-live=\"polite\">");
		sb.append("当前 "+pageNo+" /  "+pageSize+" ，共  "+count+" 条数据</div></div>");
		sb.append("<div class=\"col-sm-7\">");
		sb.append("<div class=\"dataTables_paginate paging_full_numbers\" id=\"user_table_paginate\">");
		sb.append("<ul class=\"pagination\">");

		if (pageNo == first) {// 如果是首页
			sb.append("<li class=\"paginate_button previous disabled\"><a aria-controls=\"user_table\" data-dt-idx=\"0\" tabindex=\"0\" href=\"javascript:\">上一页</a></li>\n");
		} else {
